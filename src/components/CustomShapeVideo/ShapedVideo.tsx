...
let RenderComponent : React.FC<{height : number, color : string, video : string, Heading ?: string }> = (props) => { 
            ...
            <div style = {{position:'relative', overflow:'hidden' }}>

                {
                    (
                        ...
                        !MyBrowser.isMobile() && 
                        <>         
                            <div style = {{width:'100%', position:'absolute', height : '100%' , display :'grid', zIndex:'10', justifyContent:'center', alignContent:'center', color :'white'}}>
                               <h1 style={{fontSize:'50px', fontWeight:'900'}}>  {props.Heading} </h1>
                                
                            </div>
                            <div style ={{ position:'relative' ,display:'flex', justifyContent:'flex-end', width :'100%', top:'0', left :'0', zIndex:'5', transform:'translate(0,-1px)' }}>
                                <svg  style ={{margin:'0px', padding:'0px', bottom:'0px', }} width = '100%'  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
